...
class OrganizationDenomination extends AbstractMigration
{
    public function up()
    {
        $table = $this->table('organization_denomination', ['id' => false, 'primary_key' => ['OrganizationId', 'DenominationId']]);
    ...
    {
        $this->dropTable('organization_denomination');
    }
}